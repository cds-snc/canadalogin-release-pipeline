...
kind = "docker"
environments = ["dev"]
aws_role = "github_action_push_ecr"
dns_audit = true
...
name = "backend"
kind = "ecs"
aws_role = "github_action_push_ecs"
repository = { var = "ECR_REPOSITORY" }
...
class PipelineConfigTest(unittest.TestCase):
    def load(self, content: str = BASE_CONFIG) -> PipelineConfig:
        with tempfile.TemporaryDirectory() as directory:
            path = Path(directory) / "release-pipeline.toml"
