...
class WorkflowContractTest(unittest.TestCase):
    ...
    def test_acceptance_requires_release_please_metadata_and_reports_status(
        ...
        self.assertIn('repos/$REPOSITORY/dispatches', workflow)
        self.assertIn('integration-acceptance-completed', workflow)
    ...
    def test_acceptance_gate_is_safe_and_requires_success_for_release_prs(self) -> None:
        ...
        self.assertIn('tested_sha="$DISPATCH_RELEASE_SHA"', workflow)
        self.assertIn('pr_number="$DISPATCH_PR_NUMBER"', workflow)
